...
interface DashboardProps {
    simulacoes: any[],
    qtdeSimulacoes: number,
    simulacoesMesAtual: number
    qtdeMateriaisDisponiveis: number,
    maiorForcaImpacto: number,
    maiorVelocidadeUsada: number,
    dadosGraficoPizza: { material: string, quantidade: number, cor: string }[]
}

export default function Dashboard({ simulacoes, qtdeSimulacoes, simulacoesMesAtual, qtdeMateriaisDisponiveis, maiorForcaImpacto, maiorVelocidadeUsada, dadosGraficoPizza }: DashboardProps) {
    ...
    const gerarCampo = (icone: React.ReactNode, titulo: string, quantidade: number | string, valorMensal?: number) => {
        return (
    ...
    return (
        <div className="flex flex-col gap-4 overflow-hidden p-4">
            <div className="flex flex-col gap-4 md:flex-row md:justify-between">
                ...
                <Link href={'/simulacao'} className="flex items-center gap-1 bg-laranja-impacto rounded-xl p-2 text-shadow-[1px_1px_2px_black] md:h-fit md:my-auto">
                    <FaPlus />
                    <p>Nova Simulação</p>
                    <IoIosArrowForward />
                </Link>
            ...
            <div className="flex flex-col gap-4 md:grid md:grid-cols-2 xl:grid-cols-4">
                ...
                {gerarCampo(
                    ...
                    `${maiorVelocidadeUsada} m/s`
                )}
            </div>
            <div className="flex flex-col gap-4 xl:grid xl:grid-cols-[700px_1fr] 3xl:grid-cols-[1000px_1fr]">
                <div className="bg-zinc-700 border border-zinc-700 rounded-xl p-4 flex flex-col">
                ...
                <div className="flex flex-col gap-4 lg:grid lg:grid-cols-2 xl:grid xl:grid-rows-[auto_1fr] xl:grid-cols-1 xl:h-full">
                    <div className="bg-zinc-700 border border-zinc-700 rounded-xl p-4 flex flex-col gap-3 2xl:p-6">
                        ...
                        {
                            simulacoes.length > 0 ? (
                                <div className="w-full h-[220px] 4xl:grid 4xl:grid-cols-2 3xl:gap-4">
